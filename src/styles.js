const styles = {
    ...
    heroHeadText:
      "font-black text-black lg:text-[76px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2",
    heroSubText:
    ...
    sectionSubText:
      "sm:text-[18px] text-[14px] text-[#FFD700] uppercase tracking-wider",
  };
